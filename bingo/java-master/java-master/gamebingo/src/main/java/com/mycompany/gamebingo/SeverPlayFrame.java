...
import static com.mycompany.gamebingo.SeverFrame.datain;
import static com.mycompany.gamebingo.SeverFrame.dataout;
import static com.mycompany.gamebingo.SeverFrame.serverSocket;
import static com.mycompany.gamebingo.SeverFrame.socket;
...
public class SeverPlayFrame extends javax.swing.JFrame implements Runnable{
    ...
    private javax.swing.JButton btn_SVsend;
    private javax.swing.JButton btn_next;
    private javax.swing.JButton btn_start;
    private javax.swing.JLabel jLabel2;
    private javax.swing.JTextField jNum;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JTextArea txt_SVarea;
    private javax.swing.JTextField txt_SVfield;
    ...
    public void run() {
        ...
        while(i<75){
            ...
            while(itr.hasNext())
            {
                ...
                try
                {
                    new DataOutputStream(((Socket)clientlist.get(key)).getOutputStream()).writeUTF(String.valueOf(random[i]));
                }
                catch (Exception ex)
                {
